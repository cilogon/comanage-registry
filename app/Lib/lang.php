...
//  'fd.os.source_key' => 'Source Key',
  ...
  'sh.job.arg.validate' => 'Validate locks and fail orphaned jobs',
  'sh.job.arg.unlock' =>  'Remove the specified lock',
  'sh.job.count' =>       '%1$s job(s) in the queue',
  'sh.job.done' =>        'Job shell finished',
  'sh.job.lock.fail' =>   'Stale lock %1$s (pid %2$s) cleared while job was running',
  ...
  'sh.job.lock.stale' =>  'Removed stale lock %1$d for CO %2$s (pid %3$s)',
  'sh.job.lock.validate.none' => 'No locks matched the validation request',
