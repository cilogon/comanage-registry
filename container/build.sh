...
EXAMPLES
    ...
    $0 -s 1 --repository=myorg registry mod_auth_openidc
        Build the Registry image with OIDC authentication, repository myorg,
    ...
    $0 -s 1 --image_registry=server.my.org --repository=myorg
        ...
        Build the Registry image with OIDC authentication, repository myorg,
        image registry server.my.org, and tag suffix 1. The full name of
